...
static bool UpdateDB_v1_v2()
{
    ...
    QSqlQuery query;
    QString sql = "CREATE TABLE IF NOT EXISTS 'Schnellgaerverlauf' ('ID' INTEGER PRIMARY KEY  NOT NULL ,'SudID' INTEGER,'Zeitstempel' DATETIME,'SW' NUMERIC DEFAULT (0) ,'BX' NUMERIC DEFAULT (0) ,'TSBM' NUMERIC DEFAULT (0) ,'Farbe01' TEXT DEFAULT '#000000' ,'Farbe02' TEXT DEFAULT '#550000' ,'Farbe03' TEXT DEFAULT '#ffffff' 'Farbe04' TEXT DEFAULT '#000000' ,'Schrift' NUMERIC DEFAULT (46) ,'Alc' NUMERIC DEFAULT (0) )";
    if (!query.exec(sql)) {
        ErrorMessage* errorMessage = new ErrorMessage();
        errorMessage->showMessage(ERR_SQL_DB_ABFRAGE, TYPE_WARNUNG,
            CANCEL_NO, QObject::trUtf8("Rückgabe:\n") + query.lastError().databaseText()
    ...
    sql = "CREATE TABLE IF NOT EXISTS 'Hauptgaerverlauf' ('ID' INTEGER PRIMARY KEY  NOT NULL ,'SudID' INTEGER,'Zeitstempel' DATETIME,'SW' NUMERIC DEFAULT (0) ,'BX' NUMERIC DEFAULT (0) ,'TSBM' NUMERIC DEFAULT (0) ,'Farbe01' TEXT DEFAULT '#000000' ,'Farbe02' TEXT DEFAULT '#550000' ,'Farbe03' TEXT DEFAULT '#ffffff' 'Farbe04' TEXT DEFAULT '#000000' ,'Schrift' NUMERIC DEFAULT (46) ,'Alc' NUMERIC DEFAULT (0) )";
    if (!query.exec(sql)) {
        ErrorMessage* errorMessage = new ErrorMessage();
        errorMessage->showMessage(ERR_SQL_DB_ABFRAGE, TYPE_WARNUNG,
            CANCEL_NO, QObject::trUtf8("Rückgabe:\n") + query.lastError().databaseText()
    ...
    sql = "CREATE TABLE IF NOT EXISTS  'Nachgaerverlauf' ('ID' INTEGER PRIMARY KEY  NOT NULL ,'SudID' INTEGER,'Zeitstempel' DATETIME,'Druck' NUMERIC DEFAULT (0) , DATETIME,'Druck' NUMERIC DEFAULT (0) ,'BX' NUMERIC DEFAULT (0) ,'TSBM' NUMERIC DEFAULT (0) ,'Farbe01' TEXT DEFAULT '#000000' ,'Farbe02' TEXT DEFAULT '#550000' ,'Farbe03' TEXT DEFAULT '#ffffff' 'Farbe04' TEXT DEFAULT '#000000' ,'Schrift' NUMERIC DEFAULT (46) ,'CO2' NUMERIC DEFAULT (0))";
    if (!query.exec(sql)) {
        ErrorMessage* errorMessage = new ErrorMessage();
        errorMessage->showMessage(ERR_SQL_DB_ABFRAGE, TYPE_WARNUNG,
            CANCEL_NO, QObject::trUtf8("Rückgabe:\n") + query.lastError().databaseText()
