...
//QPixmap pix("D:\_AAB\index\kbsq\kb_source_1_4_3_2\source\res\CO2.PNG");
...
private:
    ...
    void ErstelleZusammenfassung_2();
...
private slots:
    ...
    //  void on_pushButton_SpickzettelPDF_2_clicked();
    //  void on_pushButton_SpickzettelDrucken_2_clicked();
    ...
    void on_spinBox_SWAnstellen_valueChanged(double arg1);
    void on_doubleSpinBoxBR_valueChanged(double arg1);
    void on_SpinBox_P1B_valueChanged(double arg1);
    void on_SpinBox_P2B_valueChanged(double arg1);
    void on_SpinBox_P2B_2_valueChanged(double arg1);
    void on_doubleSpinBox_BxB_valueChanged(double arg1);
    //  void on_spinBox_SwBrix_3_valueChanged(double arg1);
    //  void on_spinBox_SwBrix_4_valueChanged(double arg1);
    //  void on_spinBox_SwPlato_3_valueChanged(double arg1);
    //  void on_spinBox_SwDichte_3_valueChanged(double arg1);
    //  void on_spinBox_SwPlato_4_valueChanged(double arg1);
    //void on_spinBox_alk_valueChanged(double arg1);
    //void on_spinBox_brx_valueChanged(double arg1);

    //  void on_spinBox_RE1_valueChanged(double arg1);
    //  void on_spinBox_RE2_valueChanged(double arg1);
    //  void on_spinBox_RE3_valueChanged(double arg1);
    ...
    //  void on_pushButton_RAA_clicked();
    void on_pushButton_WRA_clicked();
    ...
    void on_pushButton_WSOK_clicked();
    //  void on_pushButton_RdH_clicked();
    void on_pushButton_ETK_clicked();
    void on_pushButton_ETK_2_clicked();
    void on_pushButton_9_clicked();
    void on_pushButton_WSFB_clicked();
    ...
    void on_pushButton_VBer_clicked();
    void on_pushButton_KK_clicked();

    void on_comboBox_PT_currentIndexChanged();
    void on_doubleSpinBox_l1h_valueChanged();
    void on_doubleSpinBox_l2h_3_valueChanged();
    void on_doubleSpinBox_l2h_valueChanged();
    void on_doubleSpinBox_l2h_2_valueChanged();
    void on_doubleSpinBox_v1_valueChanged();
    void on_doubleSpinBox_bar_valueChanged();
    void on_doubleSpinBox_11_valueChanged();

    void on_doubleSpinBox_v2_valueChanged();
    void on_doubleSpinBox_WW_valueChanged();
    //  void on_doubleSpinBox_rwms_valueChanged();
    void on_doubleSpinBox_WW_2_valueChanged();
    void on_doubleSpinBox_WW_5_valueChanged();
    //      void on_doubleSpinBox_WW_6_valueChanged();
    void on_previewButton_2_clicked();
    void setBaseUrl(const QUrl& url);

    void on_SpinBox_mse_valueChanged();
    void on_SpinBox_so4e_valueChanged();
    void on_SpinBox_nace_valueChanged();
    void on_SpinBox_wme_valueChanged();
