...
int QExport::ImportSudXML(QString cDateiname)
{
    ...
    if (root.tagName() != "xsud") {
        ...
        if (!Sud.isNull()) {
            ...
            sql += "'" + s + "',";
            //Wasserquelle
            e = Sud.firstChildElement("Wasserquelle");
            if (!e.isNull())
                s = e.text();
            ...
            //Farbe01
            e = Sud.firstChildElement("Farbe01");
            if (!e.isNull())
                s = e.text();
            ...
            //Farbe02
            e = Sud.firstChildElement("Farbe02");
            if (!e.isNull())
                s = e.text();
            ...
            //Farbe03
            e = Sud.firstChildElement("Farbe03");
            if (!e.isNull())
                s = e.text();
            ...
            sql += "'" + s + "',";
            //Farbe04
            e = Sud.firstChildElement("Farbe04");
            if (!e.isNull())
                s = e.text();
            ...
            sql += "'" + s + "',";
            //Schrift
            e = Sud.firstChildElement("Schrift");
            if (!e.isNull())
                s = e.text();
                    ...
                    if (!Hauptgaerverlauf.isNull()) {
                        ...
                        while (!n.isNull()) {
                            ...
                            if (!Eintrag.isNull()) {
                                ...
                                sql += "'" + s + "',";
                                //Berechneter BX
                                e = Eintrag.firstChildElement("BX");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                sql += "'" + s + "',";
                                //Berechneter TSBM
                                e = Eintrag.firstChildElement("TSBM");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                sql += "'" + s + "',";
                                //Berechneter so4e
                                e = Eintrag.firstChildElement("so4e");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                sql += "'" + s + "',";
                                //Berechneter mse
                                e = Eintrag.firstChildElement("mse");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                sql += "'" + s + "',";
                                //Berechneter nace
                                e = Eintrag.firstChildElement("nace");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                sql += "'" + s + "',";
                                //Berechneter wme
                                e = Eintrag.firstChildElement("wme");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                sql += "'" + s + "',";
                                //Berechneter rae
                                e = Eintrag.firstChildElement("rae");
                                if (!e.isNull())
                                    s = e.text();
                                    ...
                                    s = "";
                                sql += "'" + s + "',";
                                //Berechneter Wasserquelle
                                e = Eintrag.firstChildElement("Wasserquelle");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                sql += "'" + s + "',";
                                //Berechneter Farbe01
                                e = Eintrag.firstChildElement("Farbe01");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                sql += "'" + s + "',";
                                //Berechneter Farbe02
                                e = Eintrag.firstChildElement("Farbe02");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                //Berechneter Farbe03
                                e = Eintrag.firstChildElement("Farbe03");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                //Berechneter Farbe04
                                e = Eintrag.firstChildElement("Farbe04");
                                if (!e.isNull())
                                    s = e.text();
                                ...
                                sql += "'" + s + "',";
                                //Schrift
                                e = Eintrag.firstChildElement("Schrift");
                                if (!e.isNull())
                                    s = e.text();
